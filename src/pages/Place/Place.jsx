      ...
      <div className={styles.wrapper}>
        ...
        <ul className={styles.metaNav}>
          <li>
            ...
            >
              <svg width="16px" height="16.0016895px" viewBox="0 0 16 16.0016895" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                  <g transform="translate(-33.25, -205.2492)" fill="#000000" fill-rule="nonzero">
            ...
            <a
              ...
              <svg width="12px" height="12px" viewBox="0 0 12 12" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" stroke-linecap="round" stroke-linejoin="round">
                  <g transform="translate(-193.25, -207.25)" stroke="#000000" stroke-width="1.5">
