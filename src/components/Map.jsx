  ...
  const places = [
    {
      ...
      coverPhoto: "./src/assets/places/bodega-loya-cover.jpg",
      photos: [
        "./src/assets/places/bodega-loya-1.png",
        "./src/assets/places/bodega-loya-2.png"
      ],
      longitude: -106.30,
      latitude: 31.65
    },
    {
      ...
      coverPhoto: "./src/assets/places/herb-bar-cover.jpg",
      photos: [
        "./src/assets/places/herb-bar-1.png",
        "./src/assets/places/herb-bar-2.png"
      ],
      longitude: -97.75,
      latitude: 30.24
    },
    {
      ...
      coverPhoto: "./src/assets/places/earth-commons-cover.jpg",
      photos: [
        "./src/assets/places/earth-commons-1.png",
      ],
      longitude: -97.71,
      latitude: 30.26
    },
    {
      ...
      coverPhoto: "./src/assets/places/june-bloom-cover.jpg",
      photos: [
        "./src/assets/places/june-bloom-1.png",
        "./src/assets/places/june-bloom-2.png"
      ],
      longitude: -98.41,
      latitude: 30.28
    },
    {
      ...
      coverPhoto: "./src/assets/places/comfort-botanical-cover.jpg",
      photos: [
        "./src/assets/places/comfort-botanical-1.png",
      ],
      longitude: -98.91,
      latitude: 29.97
    },
    {
      ...
      coverPhoto: "./src/assets/places/tucson-herb-cover.jpg",
      photos: [
        "./src/assets/places/tucson-herb-1.png",
        "./src/assets/places/tucson-herb-2.png"
      ],
      longitude: -110.97,
      latitude: 32.22
    },
    {
      ...
      coverPhoto: "./src/assets/places/grateful-desert-cover.jpg",
      photos: [
        "./src/assets/places/grateful-desert-1.png",
      ],
      longitude: -116.32,
      latitude: 34.13
    },
